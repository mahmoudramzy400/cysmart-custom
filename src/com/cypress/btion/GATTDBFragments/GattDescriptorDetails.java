 ...
 *
 */
package com.cypress.btion.GATTDBFragments;
...
import com.cypress.btion.CommonUtils.GattAttributes;
...
public class GattDescriptorDetails extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCharacteristicName =  rootView.findViewById(R.id.txtcharacteristicname);
        mCharacteristicInstanceID = rootView.findViewById(R.id.text_character_instanaceid ) ;
        mDesriptorUuuid =  rootView.findViewById(R.id.text_descriptor_uuid );
        mDescriptorName =  rootView.findViewById(R.id.txtdescriptorname);
        mDescriptorValue =  rootView.findViewById(R.id.txtdescriptorvalue);
        mServiceInstanceId = rootView.findViewById(R.id.text_service_instance_id ) ;
        mServiceUUID = rootView.findViewById(R.id.text_service_uuid ) ;

        mHexValue =  rootView.findViewById(R.id.txtdescriptorHexvalue);
        mBackBtn =  rootView.findViewById(R.id.imgback);
        ...
        int characteristicInstanceId = mBluetoothGattCharacteristic.getInstanceId() ;
        mCharacteristicName.setText(GattAttributes.lookupUUID(mBluetoothGattCharacteristic.getUuid(), characteristicUUID));
        mCharacteristicInstanceID.setText(characteristicInstanceId + "");
        ...
        // print uuid of the descriptor
        if (DescriptorUUID != null ){
            mDesriptorUuuid.setText( DescriptorUUID );
        }

        // Service info
        String serviceUUID = mBluetoothGattCharacteristic.getService().getUuid().toString() ;

        if (serviceUUID != null )
            mServiceUUID.setText(serviceUUID);

        int serviceIntstnceId = mBluetoothGattCharacteristic.getService().getInstanceId() ;

        mServiceInstanceId.setText(serviceIntstnceId + "");
